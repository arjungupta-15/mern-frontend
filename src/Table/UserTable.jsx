...
export default function UserTable() {
    ...
    const handleUserDelet = async () => {
        try {
            const DeletUser = await axios.delete(`https://mern-backend-9z2j.onrender.com/api/delete/${userId}`)
    ...
    const handleOnSubmit = async (e) => {
        ...
        try {
            const UpdatedUser = await axios.put(`https://mern-backend-9z2j.onrender.com/api/update/${updatedUserId}`,value)
